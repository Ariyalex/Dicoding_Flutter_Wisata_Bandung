                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        Text(place.openDays, style: infTxtStyle,),
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        ...
                        const SizedBox(height: 8.0),
                        Text(place.openTime, style: infTxtStyle,)
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        ...
                        const SizedBox(height: 8.0),
                        Text(place.ticketPrice, style: infTxtStyle,)
                      ],
                    )
                  ],
                ),
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: const TextStyle(fontSize: 16.0, fontFamily: 'Futura'),
                                ),
                              )
                            ],
                          ),
